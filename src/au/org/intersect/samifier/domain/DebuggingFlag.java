...
public class DebuggingFlag {
	...
	/// Decides whether the SAM file will use the Mascot score for the MAPQ field, which denotes mapping quality. 
	/// Value of 1 means use Mascot score, any other value debugging flag value will make MAPQ = 255.
